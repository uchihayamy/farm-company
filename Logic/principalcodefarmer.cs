...
{
    public class principalcodefarmer
    {
        public static void PaymentValueToCapitalists(List<dt_Crop> Crops, List<dt_Farmer> Farmers)
        {
            int ventas = 0;
            string name = "";
        ...
        public static void PaymentValueToFarmers(List<dt_Crop> Crops)
        {
            int ventas = 0;
        ...
        public static void LowestPriceSell(List<dt_Crop> Crops)
        {
            double valuesell = 0;
            string farmerName = "";
            string farmerGender = "";
